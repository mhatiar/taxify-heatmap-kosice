...
async function RetrieveData(city) {
		//console.log(city);
		if(city === 'ke'){
			httpOptions.host = "sia8g1c747.execute-api.us-east-2.amazonaws.com";
			httpOptions.path = "/production/get-taxify-drivers";
			httpOptions.method = "GET"
		}
		if(city === 'ba'){
			httpOptions.host = "0zvhao3pma.execute-api.us-east-2.amazonaws.com";
			httpOptions.path = "/production/get-taxify-drivers-bratislava";
			httpOptions.method = "GET"
		}
		var values = [];
            try {
